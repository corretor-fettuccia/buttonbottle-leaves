  ...
  class LeafEngine {
    ...
    animateTextChange(newText, isRestoring = false) {
      ...
      if (style === 'fade') {
        ...
        this.textSpan.style.opacity = '0';
        this.textSpan.style.transform = 'translateY(6px)';
      } else if (style === 'scale') {
        this.textSpan.style.opacity = '0';
        this.textSpan.style.transform = 'scale(0.9)';
      }
  ...
  class BtnBottleLeavesPlugin {
    ...
    extractConfig(button) {
      return {
        ...
        transitionSpeed: parseInt(button.getAttribute('data-transicao-velocidade')) || 600,
        transitionDuration: parseInt(button.getAttribute('data-transicao-suavidade')) || 200,
